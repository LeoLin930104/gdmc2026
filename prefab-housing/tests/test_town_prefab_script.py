...
root_map_manager = importlib.util.module_from_spec(_MAP_MANAGER_SPEC)
sys.modules[_MAP_MANAGER_SPEC.name] = root_map_manager
_MAP_MANAGER_SPEC.loader.exec_module(root_map_manager)
...
def test_player_position_parser_accepts_gdmc_player_data() -> None:
    ...
    assert root_map_manager._parse_player_pose(data) == (12, 64, -10)
...
def test_upstream_map_manager_uses_players_endpoint_when_editor_has_no_get_player_pos(
    ...
    manager = root_map_manager.MapManager(host="localhost:9010")
