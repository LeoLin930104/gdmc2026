...
9. Annotate semantic cells, populate room interiors, and add entry-door modules.
    ...
    *,
    ...
    block_stages = (
        *exterior_stages,
        ...
        BlockGenerationStage(
            name="entry_door_module",
            order=interior_stage_order + 1,
            operation="emit",
            category="interior",
            blocks=entry_door_blocks,
        ),
        BlockGenerationStage(
            name="interior_site_footprint_clip",
            order=interior_stage_order + 2,
            operation="clip",
            category="boundary",
